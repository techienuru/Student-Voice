...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            <div class="content">
                <div class="container">
                    <h2 class="mt-4">Unit Dashboard</h2>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-warning">
                                ...
                                <div class="card-body">
                                    <p class="card-text">Reviews with pending replies.</p>
                                    <a href="./pending.php" class="btn btn-warning">Respond Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card card-success">
                                ...
                                <div class="card-body">
                                    <p class="card-text">Reviews that have been resolved.</p>
                                    <a href="./resolved.php" class="btn btn-primary">View Resolved</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Feedback Modal -->
    <div class="modal fade" id="feedbackModal1" tabindex="-1" role="dialog" aria-labelledby="feedbackModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5>Title:</h5>
                    <p>Course Material Issue</p>
                    <h5>Message:</h5>
                    <p>The material for Math 101 is not accessible online. Please fix this issue.</p>
                </div>
